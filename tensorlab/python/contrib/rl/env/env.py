...
class Environment(object):
    ...
    def seed(self, seed=None): raise NotImplementedError("seed method must be implementated")

    def render(self, mode='human', close=False): raise NotImplementedError("render method must be implementated")
    ...
    def num_states(self):
        num = 1
        for s in self.state_shape: num *= s
        return num
