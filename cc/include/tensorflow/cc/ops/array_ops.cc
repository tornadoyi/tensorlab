...
Copy::Copy(const ::tensorflow::Scope& scope, ::tensorflow::Input input, const
           Copy::Attrs& attrs) {
  if (!scope.ok()) return;
  auto _input = ::tensorflow::ops::AsNodeOut(scope, input);
  if (!scope.ok()) return;
...
Copy::Copy(const ::tensorflow::Scope& scope, ::tensorflow::Input input)
  : Copy(scope, input, Copy::Attrs()) {}

CopyHost::CopyHost(const ::tensorflow::Scope& scope, ::tensorflow::Input input,
...
DebugNumericSummary::DebugNumericSummary(const ::tensorflow::Scope& scope,
                                         ::tensorflow::Input input, const
                                         DebugNumericSummary::Attrs& attrs) {
  if (!scope.ok()) return;
  auto _input = ::tensorflow::ops::AsNodeOut(scope, input);
  if (!scope.ok()) return;
  ::tensorflow::Node* ret;
...
DebugNumericSummary::DebugNumericSummary(const ::tensorflow::Scope& scope,
                                         ::tensorflow::Input input)
  : DebugNumericSummary(scope, input, DebugNumericSummary::Attrs()) {}
